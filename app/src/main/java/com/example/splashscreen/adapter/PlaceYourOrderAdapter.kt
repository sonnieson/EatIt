...
import com.example.splashscreen.PlaceYourOrderActivity
import com.example.splashscreen.R
import com.example.splashscreen.models.Menus
...
class PlaceYourOrderAdapter(val menuList: List<Menus?>?):RecyclerView.Adapter<PlaceYourOrderAdapter.MyViewHolder>() {
    override fun onCreateViewHolder(
        ...
        val view: View = LayoutInflater.from(parent.context).inflate(R.layout.placeyourorder_list_row,parent)
